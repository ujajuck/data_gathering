...
export default function Build() {
  ...
  return (
    <>
      ...
      <nav className="v3-stepper" aria-label="빌드 단계">
    ...
    <section className="v3-card">
      ...
      {data && (
        <div className="v3-table-wrap">
          <table className="v3-table" aria-label="대상 문서">
            <thead>
              <tr>
                <th scope="col">문서명</th>
                ...
                <th scope="col">
                  <span className="v3-small">제거</span>
                </th>
              </tr>
            </thead>
            <tbody>
      ...
      {data && data.summary.usable === 0 && (
        <p className="v3-note">사용 가능한 문서가 없습니다. 문서 상태를 정상으로 만든 뒤 다시 추가하세요.</p>
      )}
...
function SchemaStep({
  ...
  return (
    <section className="v3-card">
      ...
      <p className="v3-muted">출력할 필드를 정의한 파싱 스키마를 고릅니다. 필드마다 값이 있는 문서 수를 함께 보여줍니다.</p>
      {schemas.loading && (
        <p className="v3-muted v3-loading" role="status">
          불러오는 중…
        </p>
      ...
      {fields && (
        <div className="v3-stack">
          <p className="v3-small">필드 {fields.length}개 · 값 있는 문서 수</p>
          <div className="v3-chips" aria-label="필드 목록">
            {fields.map((f) => (
          ...
          {fields.length === 0 && <p className="v3-note">이 스키마에는 필드가 없습니다.</p>}
        </div>
      )}
      <div className="v3-toolbar v3-toolbar-end">
