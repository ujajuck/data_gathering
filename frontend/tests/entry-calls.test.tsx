...
import { ids, appFixture } from "./fixture";
...
const cases: Case[] = [
  ...
  { name: "설정", url: "?screen=settings", fixture: appFixture, landmark: () => screen.findByRole("table", { name: "정규화 프리셋 목록" }), expected: ["GET /settings", "GET /normalization-presets"] },
  {
