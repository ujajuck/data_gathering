// 파싱 프로파일 화면 테스트 픽스처: 공용 v3Fixture 위에 프로파일 쓰기 경로(import-preview · POST/PUT /profiles · approve ·
// reparse · export · revisions/{rev} · test)와 상태 필터를 덧붙인다.
import type { ProfileDetail, ProfileDocumentRow, ProfileSaveResult } from "../src/v3/types";
import { errorBody, ids, job, page, profileDetail, profileRows, reply, uuid, v3Fixture } from "./v3-fixture";
