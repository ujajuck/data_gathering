// Source Review 테스트 픽스처: 스캐폴드 v3Fixture를 확장해 검수 쓰기(리비전·복원·모두 승인)와 프로파일 테스트 응답을 더한다.
// 매핑 상태는 픽스처 안에서 갱신되어 다시 읽은 GET /applications/{aid}가 쓰기 결과를 반영한다.
import type { MappingRegion, MappingRow, MappingStatus, TestResult } from "../src/v3/types";
import { applicationSummary, errorBody, ids, job, mappingRows, reply, uuid, v3Fixture } from "./v3-fixture";
