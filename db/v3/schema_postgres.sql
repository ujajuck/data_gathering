...
-- 포함하지 않는 것: kg/v3/db.py가 런타임에 만드는 SQLite 전용 runtime_job·snapshot_signature.
-- 검증 범위: pglast 구문 검증(tests/test_schema_v3_postgres.py)만 수행했다. 실제 PostgreSQL 서버에서 실행 검증하지 않았다.
