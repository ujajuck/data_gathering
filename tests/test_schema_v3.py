"""v3 코어 DDL(db/v3/schema_sqlite.sql)의 불변식 검증(계약 §1, §11 첫 항목). 서비스/API가 아니라 DB가 막는지를 본다."""
...
from kg.v3.db import RUNTIME_DDL

ROOT = Path(__file__).resolve().parents[1]
DDL = ROOT / "db/v3/schema_sqlite.sql"
